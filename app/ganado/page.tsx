...
export default function GanadoPage() {
  ...
  const [selectedAnimal, setSelectedAnimal] = useState(livestockData.animalsList[0])
  ...
  const filteredAnimals = livestockData.animalsList.filter((animal) => {
    const matchesSearch =
      animal.name.toLowerCase().includes(searchTerm.toLowerCase()) || animal.tagNumber.includes(searchTerm)
    const matchesFilter =
      filterStatus === "todos" ||
      (filterStatus === "reproductores" &&
        (animal.category === "Toro Reproductor" || animal.category === "Vaca Madre")) ||
      (filterStatus === "engorde" && animal.category === "Novillo") ||
      (filterStatus === "reposicion" && animal.category === "Vaquillona") ||
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Producción de carne y manejo reproductivo integral</p>
        </div>
        ...
        <Card className="border-2 border-gray-200 hover:border-blue-300 hover:shadow-lg transition-all">
          ...
          <CardContent className="pt-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold">{livestockData.herdOverview.totalAnimals}</p>
        ...
        <Card className="border-2 border-gray-200 hover:border-green-300 hover:shadow-lg transition-all">
          ...
          <CardContent className="pt-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold">{livestockData.herdOverview.breedingCows}</p>
        ...
        <Card className="border-2 border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all">
          ...
          <CardContent className="pt-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold">{livestockData.herdOverview.averageWeight}</p>
        ...
        <Card className="border-2 border-gray-200 hover:border-orange-300 hover:shadow-lg transition-all">
          ...
          <CardContent className="pt-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold">{livestockData.herdOverview.averageDailyGain}</p>
        ...
        <Card className="border-2 border-gray-200 hover:border-red-300 hover:shadow-lg transition-all">
          ...
          <CardContent className="pt-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-2xl font-bold">{livestockData.herdOverview.calvingRate}%</p>
                  ...
                  >
                    <CardHeader className="pb-3 border-b-2 border-gray-100">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge className={getHealthStatusColor(animal.healthStatus)} variant="outline">
                          {animal.healthStatus}
                        </Badge>
                      </div>
                    ...
                    <CardContent className="pt-4">
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          ...
                          <Badge className={getCategoryColor(animal.category)} variant="outline">
                            {animal.category}
                          </Badge>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-semibold text-green-600">+{animal.dailyGain} kg</p>
                          </div>
                          <div>
                            <span className="text-gray-600">Condición corporal:</span>
                            <p className={`font-semibold ${getBodyConditionColor(animal.bodyConditionScore)}`}>
                        ...
                        <div className="flex justify-between items-center text-sm">
                          ...
                          <span className="font-semibold text-green-600">${animal.marketValue}</span>
                        </div>

                        {animal.alerts.length > 0 && (
                          <div className="flex items-center gap-2 text-amber-600 text-sm">
                            <AlertTriangle className="h-4 w-4" />
                            <span>{animal.alerts.length} alerta(s)</span>
                          </div>
                        )}
