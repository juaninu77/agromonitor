...
-- Las migraciones deben fallar si datos existentes no cumplen estas reglas.
DO $$ DECLARE c record; BEGIN
  FOR c IN SELECT conrelid::regclass AS tab, conname FROM pg_constraint
    WHERE contype='c' AND connamespace='public'::regnamespace
  LOOP EXECUTE format('ALTER TABLE %s VALIDATE CONSTRAINT %I', c.tab, c.conname); END LOOP;
END $$;